    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserQuestActions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MiniatureTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MiniatureTranslations_Miniatures_MiniatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestTranslations_Quests_QuestId",
                        column: x => x.QuestId,
                        principalTable: "Quests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteMiniatures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteMiniatures_Miniatures_MiniatureId",
                        column: x => x.MiniatureId,
                        principalTable: "Miniatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteMiniatures_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_Miniatures_MiniatureId",
                        column: x => x.MiniatureId,
                        principalTable: "Miniatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserActivityTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserActivityTranslations_UserActivities_UserActivityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteMiniatures_MiniatureId",
                table: "FavoriteMiniatures",
                column: "MiniatureId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteMiniatures_UserId",
                table: "FavoriteMiniatures",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MiniatureTranslations_MiniatureId",
                table: "MiniatureTranslations",
                column: "MiniatureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestTranslations_QuestId",
                table: "QuestTranslations",
                column: "QuestId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_MiniatureId",
                table: "Reviews",
                column: "MiniatureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserActivityTranslations_UserActivityId",
                table: "UserActivityTranslations",
